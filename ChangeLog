...
I was able to continue in the same save, but...
Standard Warning: 
There is no guarantee you can update the Mod List and continue in an existing save.
Only update the Mod List when you are ready to start a new game.

1. Mumpfy gave us new a splashscreen, and MO2 taskbar icon. These are great! 
I also added a new MO2 Theme, and combined, these really give our Mod List a fun distinctive look.
...
- GoFasterOnRoads
- QuestRevamp
- LittleRedSonja Ash Williams NPC
- PackWisely

-Laydor's FrameForge (formerly DLSS Super Resolution)
This is one third of the mod! If you want to unlock it's full potential for performance boosting,
you will need to MANUALLY download Frame Generation and the Unity Nvidia Module files.
Then use those to overwrite your base game files... where you see 7DaysToDie.exe...
If you do this, you could see a 17-80% boost to FPS without sacrificing visuals.

ADDED

- Zombie Color Remove: Disabled
Removes the Skittles coloration from Rads, Infernals, and Charged Zeds. Stats-wise, they remain unchanged.
For those of you who don't want to taste the rainbow.

- LittleRedSonja Ellen Ripley NPC: Disabled
Add-on to NPC Core. 
I say we take off and nuke the entire site from orbit. It’s the only way to be sure.

- New MO2 Theme for 7DtD Smorgasbord: This is not a mod. 
It provides us with a MO2 Theme for the visual UI you are looking at now (in MO2). 
You can change it from the Settings button if you prefer something else.

________________________________________________________________
2.6.1.28 18:30 EST 04JUN2026: Hotfix on Mounted Gun

**Smörgåsbord ModList Update:** ```2.6.1.27 17:00 EST 04JUN2026
...
- Wasteland Separator and accompanying mods. 

- Survivalist Separator. You can easily recreate this one yourself if you wanted to by enabling a few of those mods. 

There wasn't enough user engagement with those Profiles, and it's easier for me to maintain just one main SMorgasbord Profile.

ADDED

- The new Splash Screen when you launch MO2 was provided by Mumpfy.

- OreVision: Adds a helmet mod that allows you to see Ore Node deposits. Unlock crafting with Mother Lode rank 5.

- Funukemaguro's Military Color Dye: Adds a ton of new muted military colored dyes. They look great on Izy guns!

- Mounted Minigun Redux: Adds a craftable Mounted Minigun.

- Casino Coin Hidden Wallet: Disabled, pending update. 
Currently duplicates QuickStack Icon Buttons, and causes an icon overlap in the backpack. The mod author is working on an update... 
Automatically store, spend, and manually retrieve your coins from this wallet to save backpack space. 
Adds two new Hidden Wallet Icon Buttons in the backpack to push/pull Duke casino coins. 
Similar to PackWisely. 

________________________________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.26 17:30 EST 03JUN2026
...
- LittleRedSonja Grab Your Stuff: She kindly added the ability to pick up the special vending machine from the POI Scourge mod.

ADDED

- More Traders 8K Default Map 261
Some Community Members didn't like that my other maps only have one trader per biome. 
So this map has up to FIVE traders per biome.


Minor hotfixes 2.6.1.24-.25
__________________________________________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.23 08:00 EST 31MAY2026
...
1. I had to make a few updates to the backend of the MO2 files because NexusMods updated their TLS/SSL settings for their API Connection... tl;dr version: NexusMods downloads weren't working, now they do.
...
**Smörgåsbord ModList Update:** ```2.6.1.22 07:15 EST 28MAY2026
...
- LittleRedSonja and Mumpfy FancyWallArt - Better Posters: Decor, Disabled by default

________________________________________________________________



Smörgåsbord ModList Update: 
2.6.1.21 11:15 EST 26MAY2026
...
1. I disabled Byteblazar's Screamers by default. I enjoy it, but got too many complaints about them being too fast. 

2. I switched EFTX Z2 ammo type to "Z2 EFTX IZY Uses All The Ammo" so everything uses everything. 
Vanilla, EFTX, and Izy. 
This is because after watching a few streams of Smorgasbord recently, I saw people in the early game wish that vanilla ammo would slot into various guns. 
...
- QuickLoot: Adds Fallout 4 style quick looting. 
When looting hold left Alt, press E to grab an item, or WASD to move through loot, or Q to grab all loot. 
Will not open Fallout 4 Quick Looting while performing mounted looting (on the bicycle).

________________________________________________________________



**Smörgåsbord ModList Update:** ```2.6.1.20 21:15 EST 23MAY2026
...
- Packwisely: Now has a throwables Demolition Pouch, and more configurable in GEARS (Mods menu).

- LittleRedSonja Barbie Let's Go Party Car: Now Dyeable

- 0-Score

ADDED

-PGz Trader Only Books: DISABLED by default. 
Books, Magazines, and Schematics can only be obtained from the Trader. 
They've been removed from loot. Maybe don't enable this mod in a No-Trader Run.

Dry Dock POI

Mind Your Beeswax: Enabled
Adds a small chance for all Traders to stock Beeswax and Queen Bees in their Inventory.

**Smörgåsbord ModList Update:** ```2.6.1.19 12:30 EST 19MAY2026
...
ADDED / UPDATED
- Fire Retardant Armor Mod Liner
- Packwisely
- EFTX Pack Core
- EFTX Hard Req
- EFTX Pack Standard
- EFTX Pack Slow Progress
- Z1 EFTX 12 Slot Mods
- Z1 EFTX Meds Plus
- Z2 EFTX Both Ammo
- Z2 EFTX EFT IZY Ammo CrossOver
- Z2 EFTX EFT Only Ammo
- Z2 EFTX IZY Uses All The Ammo
- Z2 EFTX Uses IZY Vanilla Ammo
- Z2 EFTX Vanilla Only Ammo
- Z3 EFTX Food
- Z4 EFTX No Vanilla Guns
- Z5 EFTX No Vanilla Ammo
- Z6 EFTX Armored Zs
- Z7 EFTX Random Height Walk Zs
- Z8 EFTX Removed Guns
- Z9 EFTX Lootable Zs
- Z9 EFTX Workbenches
...
**Smörgåsbord ModList Update:** ```2.6.1.18 16:40 EST 17MAY2026
...
Enhanced Archery
Unofficial - Scrollable Paginated 405 Slot Backpack

**Smörgåsbord ModList Update:** ```2.6.1.17 23:00 EST 16MAY2026
...
[Removed]
Remote Explosive Charges
Beyond Storage 2
Hunlight Starter Kits
Better Intro Buried Chest
Tier 1 Common Ranged Weapons Intro Rewards
Tier 1 Melee Weapons Intro Rewards

[Updated / Added - Quests & Gameplay]
Quest Revamp - Gears Edition — Quest system overhaul
Mounted Looting — Loot while mounted
Sticky Nade — Throwable sticky explosives
Gas Shortage — Reduced fuel abundance
Reduced Looting XP — Less XP from looting
Austi's Working Machines — Functional machinery additions
Packwisely — Inventory management improvements

[Updated / Added - Vehicles]
WITOS MH6 — Helicopter vehicle
WitosRoot Osprey — Osprey aircraft framework
Barbie Let's Go Party Car — Joke vehicle addition

[Updated / Added - Combat & Survival]
ElectriZ — Electrical defense additions
Better Molotovs — Improved molotov effectiveness
Ammunition Recycling — Ammo breakdown crafting
WalkerSim — Persistent zombie simulation update
ZombiePack — Expanded zombie variety

[Updated / Added - Storage & Building]
Beyond Storage 2 — Expanded storage system
Vault Pack Combined — Additional POIs and vault content
Fancy Home Deco — Decorative furniture expansion
405 Slot Backpack — Massive backpack option

[Updated / Added - Armor & Cosmetics]
Mumpfy Armor Pack 06 Resident Evil — Resident Evil themed armor
Never Enough — Armor dye system update
Halo 3 Master Chief VRoid — Playable avatar

[Updated / Added - Farming]
Hydroponic Farming Farmer Set Compatibility — Hydroponics compatibility patch

________________________________________________________________

2.6.1.16 18:30 EST 09MAY2026
...
The Following Mods were either added or Updated:

Smörgåsbord ModList Changelog Update
...
- Better Molotovs
  Category: Weapons / Throwables

- Gas Shortage
  Category: Vehicles / Fuel Economy

- Austi's Working Machines
  Category: World / Interactables

- LittleRedSonja Ammunition Recycling
  Category: Crafting / Ammo

- LittleRedSonja Mumpfy ArmorPack06 Resident Evil
  Category: Armor / Character Customization

- BeyondStorage2
  Category: Storage / Quality of Life

- WitosRoot
  Category: Vehicles / Framework

________________________________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.15 18:00 EST 04MAY2026
...
2. If you see zombies at night not aggro-ing to the player, it is a new known issue coming from the Descent Mod. 
I have already informed the author, and he is looking into it.
...
[UI]
Game Menu Options (V2) — Expanded menu customization
Crafting Preview Stats — Shows crafting stat previews
1-SCore Blood Moon Count — Updated for v2.6

[Audio]
PGz Silent Chainsaw — Reduced chainsaw noise
PGz Silent Auger — Reduced auger noise

[Armor & Cosmetics]
LRS Never Enough — Armor dye system
LRS Vanity Vault — Large cosmetic storage
LRS + Mumpfy Armor Pack 09 (Fallout) — Themed armor set

[Weapons]
Flatlander’s Fixes (IZY AIO) — Compatibility + bug fixes

[Gameplay]
khzmusik Food Spoilage — Food decay system
LRS Ammunition Recycling — Ammo breakdown system

[World / RWG / POIs]
Zo9ks Rotterdam Tower — New high-rise POI
RWG Tweaks — Improved world generation
Terrain Block Gap Fill — Fixes terrain seams with th "/" key

[Base / Defense]
Electrified Steel Blocks — Powered defense blocks
Flamethrower Pipes — Trap-based fire defense

[Vehicles]
WitosRoot 2.2 — Vehicle framework update

[AI]
WalkerSim v1.1.2 — Persistent zombie simulation overhaul

[Maps]
7k Smorgasbord Default Map

________________________________________________________________



**Smörgåsbord ModList Update:** ```2.6.1.11 09:40 EST 26APR2026
...
"Extended World Settings Plus" Replaced with a more stable offering from Aaramus: "(V2) Game Menu Options"

"Horde 64" replaced by "(V2) 1-SCore Blood Moon Count".
The replacement mod is easier for users to configure in game settings Blood Moon Count when combined with the "Game Menu Options" mod.

Mod Updates:

"Unofficial - Scrollable Paginated 405 Slot Backpack"
"Reactive Neon Lights"

Mods Added:

"Black Wolf's STFU (A21 - 1.0 - 2.0)" Audio, disabled.
Removes the annoying, repetitive, and ear piercing sounds when an enemy gets electrified.

"(V2) Game Menu Options" Standard, enabled.
Extends game menu option setting sliders.

"(V2) 1-SCore Blood Moon Count" Zombies, enabled.
In vanilla, zombie count is locked to 30, even if you set 64 zombies within the Blood Moon Count. 
This mod allows for the full 64 to spawn. 
Optionally, you can go beyond 64, but it will effect your performance!
I tested it at 150. It is very heavy on performance, but an awesome experience if you have a high-end system that can handle it.

```
________________________________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.10 18:20 EST 25APR2026
...
"Unofficial - Scrollable Paginated 405 Slot Backpack"
"Black Wolf's better full armor set bonuses"
"Black Wolf's AC and Heater inside vehicles"

"LittleRedSonja and Mumpfy Vanity Vault" MAJOR Update, lots of new features for character customization; practically a new mod!

Mods Added:

"Don't Blind Me - No Spawn Flash" Standard, enabled.
No blinding flash upon player spawning into the world.

"PGz Stop Giving Me Magazines" QoL, enabled.
Prevents fully completed magazine series from appearing in loot, so you only find magazines that still progress your character.

"Horde 64" Zombies, enabled.
During a Blood Moon, this mod will try to spawn 64 zombies within a 100 block radius of the player. 
This mod is always on! This means, your first horde night will send 64 zombies at you at a time (as God intended). 
Normally in vanilla, even if you set Blood Moon Count to 64, the game will only spawn 30 zombies at a time. 
This mod forcibly tries to spawn 64. 
When we say it tries to spawn 64; the game is hard-coded to prevent performance degradation, so sometimes you will not see the full 64, but you should still see more than 30 making for a spicier Blood Moon.
This mod ignores what you set Blood Moon Count to in the game settings, and will always max it out to 64. 
This mod can cause more frequent and lower FPS dips than vanilla Blood Moons, but performance-wise is comparable to a vanilla T5 POI. 
This mod is compatible with WalkerSim, Blood Moon Chaos, and the rest of Smorgasbord.
You can edit the groupLiveCount condition check in GameEvents.xml  - change the 64 to whatever you like, but it will effect your performance beyond 64.
...
"LittleRedSonja and Mumpfy ArmorPack07 The Walking Dead"

Mods Added:

"Crafting Preview Stats" UI, enabled within the Steel UI suite.
Adds a tab to allow you to preview stats prior to crafting an item. 
Not compatible with CATUI, since it already has this feature. 
Only use this mod with the SteelUI or vanilla UI.

"Don't Eat My Jar" Standard, enabled.
Recipes like Boiled Eggs and Boiled Meat normally consume the jar when cooked. Now they don't. 

"PGz Storms Brewed" Survivalist, disabled.
You are able to stay out in storms without being hurt with or without the headgear.
Storms are intense and reasonably short in duration.
Visually you are impaired by increase winds and limited distance vision.
Temperature increase or decrease will change based on the biome.
Run speed is reduced due to the winds. Wearing biome headgear will remove temperature and run speed negative buffs.

"LittleRedSonja Never Enough (Armor Dye System)" Armor and Decor, enabled.
Dye any of the supported armors, choosing up to 4 different colors for each of the armor parts, blending nicely with the fabrics. 
You can dye both the currently equipped armor or the cosmetic you are wearing.
You access the dye options from within the item "Modify" screen like you would when adding any other armor mod.
It works with the vanilla UI, CATUI, Steel UI, and various backpack mods included with Smorgasbord.
It should work with other UI Suites and backpack mods, but you will have to test those yourself. 
As always, big thanks to LittleRedSonja for making adjustments to her mod so they are compatible with everything we use in Smorgasbord!

_________________________________________________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.8 19:30 EST 19APR2026
...
**Smörgåsbord ModList Update:** ```2.6.1.7 16:15 EST 19APR2026
...
"Wasteland"
"Witos MH6"
"LittleRedSonja and Mumpfy ArmorPack08 Goofy Time"
"LittleRedSonja Cosmetic Armor System (CAS)"
"Enhanced Archery Damage"
...
**Smörgåsbord ModList Update:** ```2.6.1.5 10:45 EST 17APR2026
...
Mod Updates:
"The Wasteland Mod - 6K Sample World (Vault 101 Start Point)"
"Beyond Storage 2"
"Danzo Screamer Alert"
"Flatlander's Fixes for IZY-All in One Gun Pack v5.1" now enabled.
"Novelties are Nice" fixed so you will see less of Chuck and Rancher.
"Lazy POI Pack"
Multiple Witos Helicopters
"Black Wolf's better full armor set bonuses"

Mods Added:

"OCB Leveling Tool (V2.X)" Standard, enabled.
Helps you level soil gaps at the edge line of blocks. AKA the Density Hoe. 

"Black Wolf's better biome spawns" Zombies, enabled.
Tired of only seeing Chuck in the Snow, Ranchers in the Desert, or just Crispies in the burnt forest?
This mod increases regular zombies spawning in these areas.

"Craft Bell" Standard, enabled.
Craft a church bell from the Forge. 
Works with Bell Go Bong and WalkerSim.

```

________________________________________________________________

2.6.1.3 and 2.6.1.4 17:40 EST 14APR2026

HotFix for Wasteland + LRS&Mumpfy Fallout Armor.

______________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.2 12:40 EST 14APR2026

Comments:

1. This update is likely NOT save-safe. 
Only update the Mod List when you are ready to start a new game.
...
"Danzo Screamer Alert"
"KFCUL"
"Izy AIO" (now enabled by default)

Mods Added:

"Better Driving Experience" QoL, disabled.
Allows your vehicles to clip-through small debris like cacti.

```

________________________________________________________________

**Smörgåsbord ModList Update:** ```2.6.1.1 15:30 EST 12APR2026

Comments:

1. Smörgåsbord has officially moved to stable game version 2.6!
This is a MAJOR revision! You will need to start a new save for this update!
If you are happy with your current playthrough, wait to update the mod list.

2. I moved some mods around in MO2, disabled a few for improved balance (by default), and added a bunch of new stuff. 
It would be too exhausting for me to cover all of the changes this time so you will need to update to see the changes.

3. If you haven't seen it yet, I made a new trailer for the mod list.
If you good people want to share it, I'd appreciate the exposure.
https://www.youtube.com/watch?v=SsNUjvyT7Wg

I will work on a shorter installation guide video at some point in the future.

4. I have a new project I'm working on. 
It will be recording an edited playthrough of Viridian Isles as a cinematic story... More to come.

5. Expect some more updates in the near future:
Izy is working on updating his AIO Weapons Pack. You probably won't get new weapons, just fixes.
LittleRedSonja & Mumpfy also have a new character creation customization mod on the horizon as well.

____________________________________________________

2.5.2.30 15:30 EST 27MAR2026
I forgot to add ZehMatt's latest mod:

"SoundExp (Enhanced sound experience)" Audio, enabled.
Adds realistic sound reverb and echo to 7 Days to Die. 
Gunshots ring in metal rooms, echo through concrete hallways, and sound muffled through walls. 
The mod analyzes the voxel world around you to determine room size, materials, and enclosure, then applies physically-based audio effects that change as you move between spaces. 
Fully configurable

**Smörgåsbord ModList Update:** ```2.5.2.29 15:15 EST 27MAR2026

Comments:

1. We're still on 2.5 officially until 2.6 goes stable. 
You must download/update the list on 2.5, but you can switch your game to 2.6 experimental after the download if you so choose.
If you choose to move to 2.6, NPCs have not been updated for that game version yet on the mod list.

2. Standard Warning: Do not update the mod list until you are ready to start a new save. 
There's no guarantee updating the list will allow you to continue in a save.

3. MAJOR WARNING! I have removed all of TMO's mods from the Mod List. 
This wasn't my choice. He hid his mods and I don't know if/when they are coming back, or if they'll be obtainable through Wabbajack.
I tried to contact him, but I didn't receive a response... TMO might be moving his mods to his own hosting site.
I didn't want to leave the list in a broken state, and the show must go on.
So if you have them in your Mod List already, you must put [NoDelete] in front of each TMO mod you want to keep in MO2 prior to updating the list.
If you don't do this, the next time you update the list those mods will be removed, and I will be unable to help you get them back.
For new users, I cannot obtain them for you.
If they're gone, I can not distribute my local copies to you, and do not ask for anyone at Guppy's to redistribute them.

Mods Removed:

All of TMO's mods have been removed.
"Witos Vans". I didn't realize they were deprecated.
"Path Smoothing". 'needs an update because of vanilla AI changes.
"Braindead Zed". 'needs an update because of vanilla AI changes.

Mods Updated:

"Deluxe Block POI Pack by FNS"
I replaced TMO mods and blocks with the UBBI mod and blocks in these POIs.
Thanks LRS!

Mods Added:

"Trader Never Closes" QoL, enabled.
Does what it says.

"Dot Crosshair" UI, enabled.
Replaces the vanilla crosshair with a small white dot. Compatible with "Immersive Crosshair", do not combine with "Crosshair Hub".

"Crosshair Hub" UI disabled.
Customizable Crosshair. Do not combine with the "Dot Crosshair" mod.


```

**Smörgåsbord ModList Update:** ```2.5.2.28 18:45 EST 26MAR2026
...
3. I created a new separator for Witos Advanced Vehicle Mods: 
Witos's flying and/or firing vehicles do have requirements.
I would consider his flying/firing vehicles (and requirements) for advanced users who are true vehicle enthusiasts.
Too many casual users will not like the more complex controls, UI, and camera which is why these mods are disabled by default.
With the update of the their requirement mods, I tested firing vehicles without issues. 
It's vitally important you read the mod notes, go to the NexusMods pages, and/or watch the videos on how to use these mods.
Example: Tanks require diesel to refuel.
You must mount weapon mods to some of the vehicles to make them work. 
You must keep specific ammo in your backpack... vanilla .762, K-Rounds, Missiles, etc.
Hold Left-Alt and press 1-3 to change weaponry. G key fires. 
...
"Funuukemaguro's Door Knocker"
"Funuukemaguro's Requiem(RE9) Early release"
"Medical Conditions"
"Beyond Storage"

Mods Added:

"Viridian Isles 8k" POI, enabled.
Custom handmade map of islands designed by Grimlok. 
If you ever wanted to play a game centered on using boats to island-hop, this map is for you!
You can select this map just like you would a vanilla pregen world when you go to start a new game.
Yes, this map has traders.
Notice:
1. You must disable Biome Progression in-game settings for this playthrough! 
2. I recommend that you keep the Witos Boats mod enabled for this playthrough as they will be your primary means of conveyance. 
3. Reminder: Custom maps like this do not include modded POIs. 
But don't let that stop you from playing this map, because Grimlok handcrafted an amazing world!

"Hostile Architecture" Zombies, disabled.
Makes breaking blocks painfully realistic (for enemies, not players). 
You can change the setting from the in-game Mods (Gears) menu.

"Military Tablet" OP, enabled.
Adds in a military tablet and smartphone. 
If you've ever found yourself looking through an entire POI multiple times this stops that completely! 
With the functions of both items you can now see where the zombies are on the map on the handheld device.
The tablet has a see through function allowing the player to see through immediate walls. 
While the smartphone has a flashlight function allowing the player to seek the zombies even in complete darkness.

"Starting Bicycle For Streamers and Busy People" QoL, disabled.
Lets you start your zombie-slaying adventures with the bicycle.

"No Loot Bags" Survivalist, disabled.
Entities no longer drop loot bags. 
For those of you looking for more of a challenge or greater sense of realism. 
Only works on zombies and animals that use vanilla naming structures like contains 'zombie' or contains 'animal'... 
so if a mod adds entities with a fruit loop naming convention, it no worky.

"Witos Advanced Vehicles" Separator, Disabled.
A ton of new vehicles, some with functional weaponry!
...
**Smörgåsbord ModList Update:** ```2.5.2.27 15:30 EST 21MAR2026
...
Svarii's individual POIs were replace by his new POI Pack. 
...
"Funuukemaguro's Door Knocker" Weapons, enabled.
You must use some of the requirement mods used with EFTX.
See NexusMods page of this mod for the full list of requirements.
This mod adds a single-shot anti-tank pistol called a Door Knocker.

"Tier 1 Melee Weapons As Intro Buried Supplies Rewards" Quest, disabled.
Does what it says. 

"Svarii's Prefab Package" POI, enabled.
POI Pack. 

```

**Smörgåsbord ModList Update:** ```2.5.2.26 12:15 EST 19MAR2026
...
"LRS Ammo Recycling"
"WalkerSim"
"More Skill Points per level" 3, 5, 10. I edited the mod names so these load late.

Mods Added:

"Funuukemaguro's Requiem(RE9) Early release" Weapons, enabled.
"Funukemaguro's HK G11K3" Weapons, enabled.
You must use some of the requirement mods used with EFTX.
See NexusMods page of this mod for the full list of requirements.
This mod adds the heavy pistol from RE9 Requiem.
This mod adds an HK G11K3.

"Into the Void" POI, enabled.
Adds cave entrances to the Descent into a handful of vanilla POIs. 

"TiaoZaoMiniMap" UI, disabled.
Adds a minimap to the in-game UI at the Middle Right of the screen.
You can adjust settings from the in-game (Gears) Mods menu, under Quartz.
You can toggle it on/off with the NumPadEnter key.
This is compatible with either Steel UI, CAT UI, or the Vanilla UI.

```

________________________________________________________________

**Smörgåsbord ModList Update:** ```2.5.2.25 14:30 EST 16MAR2026
...
"Storage Sync"
"Kill Feed"
"LittleRedSonja T2 into T3 grade weapons"
"Medical Conditions"
"(V2) Oakraven Power Things"
"FNS Minibosses"
"Deluxe POI Pack by FNS" 
I watched a few YouTubers camping instead of commiting to an intended combat in a few of my POIs.
We can't have that now can we? :P

Mods Added:

"Smart Spotlights" Standard, enabled.
You can now craft improved spotlights you can aim and auto-swivel to targets like turrets.

"Harry's L4D2 Zombie Sound Replacer" Audio, disabled.
Multiple Mods. Replaces many standard zombie noises with those from Left for Dead 2. 
These are compatible with the other zombie noise replacer mods, but these may override some of those.  

"Peek Lean" Weapons, disabled. 
This mod allow you to peek corners by leaning to the left or right.
'Makes stealth clearing feel like Stalker.
It is compatible with all of the weapon mods I tested. 
You will need to remap keybinds in the game settings to use this mod!
﻿It allows you to peek/lean using two keybinds (Q and E by default).
I recommend you make the F key the Interact key, and use H key for the Light-source on/off.
For the mod itself, you can swap the keybinds in the (Gears) Mods menu if you don't want to use Q and E.
Be careful if vanilla or other mods use your prefered keys.
I have not tested this mod in multiplayer / dedicated server!
It's an awesome mod, but I disabled it by default because some players won't want to remap their keys. 
...
**Smörgåsbord ModList Update:** ```2.5.2.24 14:15 EST 08MAR2026

Comments:

1. Minor update this week. I'll try to clean up some of my own POIs and make mod updates next week. 
I assume (making an educated guess) that TFP will make 2.6 Stable around 13MAR2026, and will plan for updates next weekend.

2. Thank you to Eye of Wolf for noticing the cop-puke bug, MPL for pointing me in the right direction, and ByteBlazar for his rapid response with updating XFX.
...
"Perk Mastery"
"DismemberRandomizer"
"Hunlight's Loot Rebalance"
"XFX"


Mods Added:

"QueenSilly's The Lux" POI, enabled.
Modern house.
...
2.5.2.22 and 2.5.2.23 were hotfixes for EFTX and my own mistakes in Wabbajack.

________________________________________________________________

**Smörgåsbord ModList Update:** ```2.5.2.21 09:30 EST 01MAR2026

Comments:

1. Minor patch, mostly for EFTX. 

2. Standard Warning: There are no gurantees you can update the Mod List and continue to play in the same save.

3. Officially, Smorgasbord is still on game version 2.5. 
Unofficially, this version of the list is working for me in game version 2.6
...
"OG Trader Joel Voice Lines" Audio, enabled.
Gives Trader Joel his (better) old voice back. The new guy sounds like a used car salesman.

```

________________________________________________________________

2.5.2.20 16:30 EST 27FEB2026

Comments:

1. We're still on STABLE game version 2.5. 
Smorgasbord will not move to v2.6 until it goes STABLE.
I haven't tested it on 2.6 yet... I'm hoping there won't be any issues.

2. 

Mods Removed:

Superfluous Steel Suite mods. Thanks wellslls!

Mods Updated:

"Animal Pain Sound Remover"
"Quest Revamp-Gears Edition"
"More Quest Options"
"DismemberRandomizer"
"Medical Conditions"
"Army Biological Center" POI
"GoFasterOnRoads"
"PerkMastery"
"AlternativeBloodMoons" Added GEARS support. Thanks ALo.
"Singularity"
"(V2) Oakraven Rock Drill"
"EFTX Suite"

Mods Added:

"TMO's Performance Plus" Performance, disabled.
Reduces grass, trees, debris, and makes performance increases. 
This is best for low-end systems and servers.

"Sifu Drathos Master Conductor" Audio, disabled.
Music overhaul mod. Some of it's great, and it's fun to try for the variety.

"OmniSprint" OP, disabled.
Sprint in any direction, not just forward.

"Pick Up ALL The Chairs (including broken chairs and plastic seats)" Standard, enabled.
Does what it says.

"LandClaimBlocksPreventSpawning" Standard, enabled.
Does what it says.

"Discord Log Hook" QoL, disabled.
Discord Log Hook mod that allows dedicated server operators show game messages in their Discord.

"Wash Your Body" Standard, enabled.
Adds sinks, showers, and baths you can craft to wash away the Smell debuff. 
Search for "Plumbing" in the crafting menu to create the new block. 
You can change the model of the Block to shower, bath, sink, etc.
Go near the block, loot it, it will take a minute to wash your body, but it grants you 60 minutes of smell immunity.
I was working on a similar consumable Deodorant Spray, but can't get it to work, if someone wants to help...

"LittleRedSonja Ash Williams NPC" NPCs, disabled.
Ash, from the Evil Dead series.

"Training Doug" POI, enabled.
Dog Training facility.

"Rainstorm" Performance, enabled.
Overhauls the vanilla clouds, skybox, and visual weather effects systems. 
It adds new volumetric clouds and volumetric fog and a physically based skybox, with more to come. 
You can change the preset in the in-game Mods (Gears) menu. Make it foggier
You might see a slight hit to performance, 1-5 FPS.

"Drone Rework" Standard, enabled.
You add various (vanilla) medical items to your (vanilla) Drone's Inventory, it detects your (vanilla) ailments and uses the right meds automatically.
Example: Player breaks arm, Drone has a cast in it's inventory, Drone applies cast to player.

________________________________________________________________

2.5.2.19 18:20 EST 17FEB2026
...
"Dewtas Remove Quest Time Restrictions"
Both were removed since they were made redundant by ALo's "Quest Revamp-Gears Edition"

Mods Updated:

"Hunlight's Placable Base"
"Danzo's Screamer Alert"
"Quest Revamp-Gears Edition"
"DismemberRandomizer"
"Medical Conditions"
"RWG Tweaks"
"LittleRedSonja and Mumpfy ArmorPack09 - Fallout"
"0-SCore"
"FNS Make Quest Rewards Great Again"

Mods Added:

"Animal Pain Sound Remover" Sound, disabled.
For people who don't like the whine sound animals make as they die.

"(V2) XFire Bucket (0-SCore)" QoL, enabled.
Adds a Fire Bucket to extinguish fires.

"More Quest Options-Gears Edition" Quest, enabled.
Adds a few more options in Gears for quests.

"8kNoTrader_Default_Map_252" POI, enabled.
This is a 'No Trader' map for those of you looking for a unique challenge.

__________________________________________________________

2.5.2.18 10:15 EST 11FEB2026

Hotfix: NexusMods removed this mod so I had to pull it from the list for now.
"Modern Houses Revival"

__________________________________________________________


2.5.2.17 08:45 EST 11FEB2026

Warning: There's no guarantee you can update the mod list and continue to play in the same save. 
If you are happy with your current playthrough, don't update until you are ready to start a new game. 
...
"Loot Abundance Not Ignored" Because it was redundant with the new "Not So Empty" mod. 
...
"DDG_AutopickupArrowsAndBolts" QoL, disabled. 
Autopickup. Arrows and bolts are automatically collected when you pass over them. Also applies to dead entities with arrows/bolts in their bodies.
Visual indicators (NavObjects). An arrow icon will appear (ONLY on the screen, not on the compass or map) indicating the exact location where the projectile is “sticked,” showing the distance between you and it. 
If it is on an entity, the number of projectiles “sticked” will also appear.
Loot grouping on corpses. When despawning a corpse, incrusted arrows/bolts are released into bags grouped by type and quantity, avoiding dozens of individual "bags".
From Fin: The on-screen NavObjects are too visually busy for my taste. I wish there was a way to disable the NavObjects.  

"Halicopter" QoL, enabled.
Halicopter is a new drone that can return to your base to drop items off for you while you carry on exploring.
Place a Halipad at your base, fill him up and ask him to go home. The bags of loot will be waiting for you when you get back (hopefully).
If you start a new game, you will receive one free from the trader.
If you enable this mod midsave, it won't hurt anything, but you will need to award yourself the halicopter from the creative menu/craft it yourself.

"Black Wolf's better full armor set bonuses (1.0 and 2.0)" OP, enabled.
From the Author:
After playing for a while I noticed that despite the developers and the game encouraging it, most full armor sets are simply not worth picking over wearing the best pieces of armor available from different types. 
This mod makes wearing a complete set of vanilla armor worthwhile.
See NexusMods page for details.

"(TMO) Wandering Hordes PLUS x EAC Friendly x v2.4Stable" Zombies, disabled.
Will not work with WalkerSim! 
From the Author: Want to take control of your Horde Sizes and how often they Spawn in? This is the Mod for you. Simple. Effective. Scary as Hell.

"Zombie Invasions" Zombies, disabled.
Hordes of zombies will invade and attack you every in game day. 
Once the timer runs out zombies will spawn and hunt you down. 
Invasions get harder each time they happen. 
Also included items that will add/remove the invasion buff. Need to start a new game. 
If you don't want to start a new game, you need to make the Hive concoction and that will allow you to be invaded.

"More Armor Plates 1.0" OP, disabled.
Adds new armor mods.

"Modern Houses Revival" POI, enabled.
Brings back 3 vanilla modern houses missing in 2.5 RWG.
Reminder: You will need to perform Advanced RWG to create a new world to see these.

"Not So Empty" QoL, enabled.
From the Author:
If you ever tried lowering Loot Abundance under 100%, you might have noticed containers often have no items as a result.
This design is intentional, but not great if you ask me.
This tiny mod tweaks loot abundance so that every time it detects a container is empty as a result of loot abundance (as opposed to just having bad luck), one extra roll is made, with a chance of spawning one item.
The chance of this roll succeeding is the loot abundance value itself, so at 50% loot abundance, it's a 50% chance, and at 25% it's 25%, etc.
In addition to that, it applies an XML tweak that causes all containers to honor loot abundance, so things are more balanced at the lower end of the scale.

__________________________________________________________

2.5.2.16 11:00 EST 09FEB2026
...
Small correction in the Survivalist Profile. 
I accidentally left "Sleep until morning" and "Insomnia" both enabled. 
I corrected this.
...
1. Regarding "7 Days Super Resolution", Laydor released an Add-on for Nvidia GPU users called "Unity Nvidia Modules".
You can choose to manually opt in to this yourself.
It's optional, and requires EAC to be disabled. So, if you play vanilla with EAC enabled sometimes, don't do this.
It requires you to manually drag the file into your 7DtD root directory to replace the vanilla files. 
These optional files are to help improve image quality.
If the game updates versions, you will probably need to repeat this manual installation process. 
Reminder: Super Resolution is only for Windows, not Linux/Mac.  
...
"LRS CAS"
"LRS & Mumpfy Fallout Armor"
"DismemberRandomizer"
"7 Days Super Resolution"

Mods Added:

"Food Spoilage and Preserved Goods" Survivalist, Disabled.
Introduces food spoilage to the game, and new preserved foods that do not spoil. 
You have to read 55 Electrical Wiring magazines to unlock the ability to craft Powered Refrigerators to keep food from spoiling (into rotten flesh). 
See NexusMods for details.

__________________________________________________________

2.5.2.14 13:00 EST 06FEB2026
...
"Quartz"
"POI Scourge"
"Minimize Mining Reliance"
"KHZMusik Zombies"
"KF SFX"
"KF CUL"
"Medical Conditions"
"The Wasteland"
"Audible Breaking Glass"
"Goodbye Stone Tools"

Mods Added:

"Molotov cocktail shale oil" OP, Enabled.
2nd recipe for Molotovs. 

"Food Can Craftable" OP, enabled.
Recipes that allow you to craft Canned Food.

"Less Grass"
"Less Tree" Performance, enabled.
Reducing trees and grass can boost performance slightly (5-10 FPS). Must toggle mod in a new world.

"Byteblazar's RWG Tweaks" Experimental, disabled.
Not your average RWG tweaks. Improve POI diversity, prevent duplicates, cap POI tiers by biome, etc. 
This mod can wreck your RWG process if you don't understand what you are doing. 
Please read the NexusMods page carefully before using.
Note from FNS: if using Modded POIs like those in Smorgasbord (above 100x100 size) with ByteBlazar's RWG Tweaks mod, set Wilderness POIs to Few when generating a world.
I successfully tested the RWG Tweaks mod with these other RWG mods: ISI Randomized Traders, ISI World Gen Tweaker, and PGz All Map Size Generation.
I have not tested this mod with CompoPack/CUBP, and wouldn't recommend the combination. 

"16k_Default_Map_252" POIs, enabled.
Another map for Smorgasbord, but jumbo-sized for you folks who play multiplayer, or just want a a massive world to explore in a long playthrough.
I've been thinking about settling in for a slower progression longer playthrough that forces me to use Vehicle Madness for a better vehicle.  
I used ByteBlazar's RWG Tweaks to create this Map.
The main takeaway is this: you will not see duplicate POIs within the same biome.
Yes, you will see duplicate POIs in different biomes.

__________________________________________________________

2.5.2.13 13:00 EST 30JAN2026
...
"CAS" 
"WalkerSim"
"War3zuk HD Supply Drops"
"Extended World Settings Plus"

Mods Added:

"KHZMusik NPCs" NPC, disabled.
Adds Psychos, Rogues, and Civilians.

"KHZMusik Zombies" Zombies, enabled.
Adds some new zombies.

__________________________________________________________

Smörgåsbord ModList Update: 2.5.2.12 11:00 EST 27JAN2026
...
1. A few hotfixes for EFTX when using vanilla ammo options. Also added a few cool new mods.

2. Fixed the "No NerdPole" issue. It was a setting in "Gears changes SCore" mod. 
You can change settings from that mod in the in-game Mods menu.
Currently, it's set so you can one-block-crouch, and nerdpole-ing is authorized. 

3. Big thanks to both Community Members and Mod Authors who identified issues, reported them, and helped to correct them quickly. 
You guys are great, thank you for everyone's support this week!
You all make maintaining this big list of mods so much easier.
Just so everyone knows, Mod Authors like LittleRedSonja, StallionsDen, ALo, ByteBlazar, Laydor, bdub, sphereii, and many others make maintaining Smorgasbord possible.
...
"Loot Abundance Not Ignored" QoL, disabled.
From the Mod Author Frantic Dan: 
There a several loot containers, including zombie loot, that ignore the loot abundance setting, so it is always 100% regardless if you set it to 25% or 200%.
This mod makes it so all containers get the amount of loot that is selected. 
Making the game either easier or harder, depending on your loot setting.

"War3zuk HD Supply Drops" OP, disabled.
This mod add 4 Flares that can be used to call a Supplies Chopper that will drop you the loot box.
HD Building Supply Flare
HD Health Supply Flare
HD Ammo Supply Flare
HD Food Supply Flare
Each drop has it's own custom supplies. 
Flares are found inside Army Trucks & Munitions boxes but are set to Rare finds.
I tested that this works, but not how often the flares show up in loot... 
In testing I saw good weapons dropping too early, that's why it's disabled by default under the OP separator.```

__________________________________________________________


Smörgåsbord ModList Update: 2.5.2.11 09:15 EST 26JAN2026

Minor Hotfix: I forgot to enable the bdub's Vehicle mod in the Survivalist Profile.

Also updated WalkerSim.

That's it.

__________________________________________________________

Smörgåsbord ModList Update: 2.5.2.10 14:45 EST 25JAN2026
...
1. "What's that pumpkin outside of POIs?"
When you clear a POI, it places a lit jack-o-lantern pumpkin outside of it automatically to mark it as a cleared POI.
It prevents the POI from being offered by the traders as a quest again. 
It comes from the "POI Scourge"
It also awards you points to spend in a special trader option. 

2. Added a new Profile called Survivalist in MO2. It's for people who want a harder slower game.
...
"LittleRedSonja and Mumpfy ArmorPack09 - Fallout" Armor, disabled.
This Armor Pack is Cosmetic Only. So you can look like the NCR Ranger if that's your jam.
This works in Wasteland, where I toggled it as enabled in that Profile.
However, in Wasteland, the Cosmetics will bleed through if you are wearing Power Armor.
So turn off the Cosmetics in the Wardrobe prior to gearing up in Power Armor.
LRS has been informed, and will look into it as time permits.  

"Drums of War" Quest, enabled.
Craft a Drum of War, place it and beat the Drum of War inside of an active quest POI (Clear/Infested). 
This will activate all remaining Sleeper Volumes at once.
This was made to help you finish stuck Clears in POI Quests.
Warning! I would not recommend going into a tier 5, and activating the drum of war if you haven't cleared any volumes yet. 
Simultaneously spawning hundreds of zombies could cause your game to crash. 

"BdubsVehicles2VehicleMadness" Vehicles, enabled.
Adds damaged and repairable versions of Bdub's Vehicles to the game world, spawning in the style of Vehicle Madness.


__________________________________________________________

2.5.2.9 12:45 EST 24JAN2026
...
"Ophidiophobia" The mod author keeps updating and breaking the folder format.
I'm tired of fixing the folder formatting every time he updates this mod.
If you want the mod, manually add it and fix the formatting yourself.
...
"KFC UL"
"Zweihander"
"Singularity" Thank you Byteblazar for supporting Linux users.

Mods Added:

"Minimize Mining Reliance" OP, disabled.
Changes the boulders in game to give you a small chance at mining Coal, Potassium Nitrate Powder, Lead, Sand, Clay and Rare Gems.
Also doubles the amount of collected materials from above and below ground ores and boulders.

__________________________________________________________


2.5.2.8 19:15 EST 23JAN2026

Warning: You might need to start a new game for this update... 
...
"5k_Default_Map_252" POI, enabled.
Map.

"Vehicle Madness" Vehicles, enabled.
Must be enabled for a new game! Do not toggle midsave. 
This is a major vehicle overhaul mod. Adds new workstations, and process to repair some of the existing vehicles you find in the world. 
Read more at: https://community.thefunpimps.com/resources/vehicle-madness.74/ 

__________________________________________________________



2.5.2.7 08:15 EST 23JAN2026

Warning: You might need to start a new game for this update, EFTX was updated, and it can be temperamental overwriting an existing save.
When in doubt, don't update your Mod List until you are prepared to start a new save. 
...
"Pulverizer"
Weapons, enabled.
These are melee weapons and weapon animations from KF2. I would consider these tier 4 melee weapons. 
These mods rely on the same requirements as EFTX/Closer's Weapon Pack.

"Kill Feed" UI, disabled.
Kill feed that shows who killed who, what weapon they used, and headshots!

"Buy on Day One - Vehicle Parts and Mods" OP, disabled.
All (vanilla) vehicle parts available at the trader on day one.

__________________________________________________________

2.5.2.6 21:00 EST 20JAN2026

Warning: You might need to start a new game for this update, EFTX was updated, and it can be tempermental overwriting an existing save.
When in doubt, don't update your Mod List until you are prepared to start a new save. 
...
"Rainstorm in the Pine Forest" Survival, disabled.
Does what it says.

__________________________________________________________

2.5.2.5 16:00 EST 19JAN2026
...
"WalkerSim"
"7 Days of Insomnia"
"Steel UI Patch" The 15 Slot belt patch now works, enabled.
"EFTX Suite"
"Closer's Weapon Pack"
"KFCU"
...
"Survivor's Appetite" Survival, disabled.
Food overhaul to make it more challenging. 
It also makes mid-game food much more valuable.

"Kill Feed" UI Suite, disabled.
Kill feed that shows who killed who, what weapon they used, and headshots.

"Textual Repairs" Standard, Enabled.
When you try to repair/upgrade but don't have the required items, the game shows the item icon. 
Textual Repairs adds the missing item's name to it.

__________________________________________________________


2.5.2.4 17:00 EST 16JAN2026

Warning: I disabled Izy AIO and changed the EFTX Z2 ammo selection. 
Either reconfigure your mods, start a new game, or wait to update to begin a new play through.

Comments:

1. I disabled the IZY AIO and add-on mods to it because I got tired of the comments and complaints about the animation bug.  
I get it, but they're not going to be fixed until the next update to that mod, and I don't know when that is.  

2. I added a splashscreen image when MO2 opens. 

3. TFP moved 2.5 Stable from b23 to b27. Smorgasbord is compatible with both. It made a minor fix to the Apiary (Bee Hive workstation). 

Mods Removed: 

1. "Better Foods" was having a conflict with Medical Conditions. Easier to remove Better Foods...

2. EFTX Ammo and Attachment Compatibility mods... the new cursor hover features.
These mods need a bit more time in the oven.  
They'll be back.

Mods Updated:

"LitteRedSonja Zombie Pack"
"Descent" Fixed Dedicated Server issue.
...
2.5.2.3 11:00 EST 13JAN2026

Minor update:
I previously forgot to actually INCLUDE the Wasteland profile.
It's there now.

Mods with Status Updates:
I enabled and moved a few minor mods that were experimental after confirming they worked without error.
These mods tested fine in multiplayer for us, moving to QoL, enabled
TraderSync, StorageSynce, and Party Scout.

Notice: 
The EFTX cursor-hover mods for Ammo and Attachment Compatibility work in singleplayer, but are not yet fully functional in Multiplayer.
I could run them fine on my hosted game, but my son had a benign (silent) error. 
StallionsDen has already been informed. A fix will likely come in time.
...
2.5.2.2 was an unecessary hotfix. No changes.

2.5.2.1 17:20 EST 12JAN2026

WARNING! This is a major update, it requires you to start a new save and world. 
If you are content with your current playthrough, finish it prior to updating the list.

Comments:

1. EFTX received a major update with some awesome new features; notably, being able to cursor-hover over an EFTX gun to see compatible weapon mods.
You can also cursor-hover over EFTX ammo to see which guns it is compatible with.
These major QoL features were brought to us by the Asylum Overhaul Mod team. 
Big thanks to them. If you like Smorgasbord, they run many of the same mods in their overhaul pack.
The major difference is their focus on horror and new entities. 

2. I’ve added a Wasteland Profile inside of MO2 for Smörgåsbord.
...
What Is Wasteland?
If you haven’t played it before, Wasteland is a major overhaul mod designed to make 7 Days to Die feel more like Fallout.
It makes significant changes to core game systems, progression, and the overall gameplay loop.

What to Expect
You begin with a blacked-out screen.
You must spend 21 attribute points before you can begin a new game.
After that, gameplay proceeds with familiar early-game 7DtD challenges.
The overhaul introduces a completely different perk progression system.
This is not a small tweak — it meaningfully alters how the game works.

Important Warnings!
Please read these carefully before using the Wasteland profile.

Warning #1 — Support Expectations
Do NOT ask bdubyah or the Wasteland Discord for help with issues related to:

Running Wasteland inside MO2/Smörgåsbord
Any hybrid setup involving this profile
Their expected response will be:
Remove all other mods and start a brand new game.
Or troubleshoot it yourself.
That’s fair on their end. This setup is outside their intended support scope.

Warning #2 — Experimental Profile
This Wasteland profile is experimental in MO2.
That said:
I have personally playtested the delivered profile
No errors appeared
No concerning warnings appeared
Several hours of gameplay were stable
Still, this is provided as-is.

Warning #3 — This Profile Is Fragile
This is the most important section.
The normal Smörgåsbord profile can tolerate a lot of mod toggling during a new game.
The Wasteland profile cannot.
Consider this MO2 profile to be extremely fragile.

Safe:
You can disable mods you don’t want, and the profile will usually continue to function (in a new game).

Unsafe:
Enabling additional mods is very likely to break things.
Mods touching any of the following are especially risky:
UI
Progression
Recipes
Traders
...
Armor
Weapons
Enabling even a single incompatible mod can introduce errors.

No Patch Support
To be very clear:
We will not be making compatibility patches
We will not be troubleshooting custom combinations
This is provided on a take it or leave it basis
If you enjoy experimenting and understand the risks — great.
If not, you should probably stick with the standard Smörgåsbord profile.

Final Notes about the Wasteland
This exists for players who:
Want to experience Wasteland
Prefer using MO2
Understand experimental setups
Are comfortable self-troubleshooting
If that’s you — have fun.
If not — totally fair, skip this profile.
If you want to complain about how it adds GB to the download for something you don't plan on using, don't waste your breath.
I added it since I was having fun watch Glock9 play it.

Back to Smorgasbord...

Mods with a Status Change:
"Closer's Experimental Weapon Pack" moved to Pending Update. It is throwing a game breaking error with the updated EFTX now.

Mods Removed: 

"EFT Recoil Patch (For Extraction Pack)" It wasn't working right, probably needs an update. 

Mods Updated:

"EFTX Suite" Major update!
"Advanced Research" Updated for EFTX (big thanks to StallionsDen!)
"Ammo Press Add-on..." Updated for EFTX (big thanks to StallionsDen!)
"Singularity"
"No Blurry Textures"
"WalkerSim"
"CustomFPVFOV"
...
"Wasteland" Separator. 
This is only to be used in the Wasteland Profile!
I added the Wasteland and a few of the default maps.
Optional Add-on mod you can manually include on your own:
https://7daystodiemods.com/non-script-radios-video-games/
Play Fallout music in your game from a radio. 

"Jen Model Revival" QoL, enabled.
Brings the A19-V2.4 Jen back to 2.5+. 
For those of us who prefer her former appearance.

"Party Scout" Experimental, disabled.
Let's any player's map discovery show on all teammates maps. 
All players effect one another's map fog of war. 
I have not had an oppurtunity to test this. 

"LittleRedSonja Sonja's Vanity Vault" Decor, enabled.
Adds new custom hairs and face paints that you can choose directly in the character creation UI, so they can be used together with any armor.
She's just too good to this community. :P

__________________________________________________________


2.5.1.12 16:00 EST 10JAN2026
...
1. Added Steel UI and some updated mods.

Standing Community Requests:

1. If any of you have suggestions for improving the GitHub look, functionality, or have ideas for new pages then please let me know.
...
"Steel UI" UI, enabled.
My favorite UI. A new mod author created a temporary band-aid patch to get Steel UI to work in 2.5.
I only did very brief testing. If you encounter problems, please let me know ASAP. 
The 15-Slot toolbelt (and add-on patch) aren't working correctly. Stick with 10 or jump enable 20.

"Longer Lasting Buffs Remove Water Change Over Time" OP, disabled.
This is an add-on to "Longer Lasting Buffs - 10x", 
If using the main mod, you should strongly consider enabling this mod as well so you don't spend hours trying to replenish your hydration from drug side-effects.

"9k_map..."
Another Smorgasbord default map. 

__________________________________________________________


2.5.1.11 07:30 EST 09JAN2026

Comments:

1. For DLSS fans, Nvidia has opened access to the new DLSS 4.5 in beta. 
A. To use it, you must update to the latest Nvidia GPU Driver.
B. You must manually update your game to the latest DLSS dll file. I personally update the DLSS Swapper application, and manage them there.  
C. You have to opt into it yourself within the Nvidia Geforce app > Settings > About > Early access to beta. This will be standard after 13JAN2026.
D. If you are on a 20 or 30 series Nvidia GPU, you may want to stay on the K preset. If you are on a 40 or 50 series GPU, experiment with the M preset. 
I am using the latest DLSS 4.5 with Preset M on a 5090. Currently playing with DLSS set to Quality to maintain higher native FPS.
I experimented with both Ultra Quality and DLAA, but saw significant FPS drop.
...
"Natural Selection"
"Singularity"
"(TMO) Advanced Bullet Casing Collector x Client Side"
"(TMO) Zombies Cant Dig x ServerSide Friendly_v2.4Stable"
"7 Days Super Resolution(DLSS)"
"GoFasterOnRoads"

Mods Added:

"StorageSync" Experimental, disabled.
StorageSync let's players use the same storage container at the same time and keeps the inventory list synced for everyone.
I haven't had the oppurtunity to test this yet. Please let me know if it works in multiplayer without issues.  

"Army POI" POI, enabled.

"Customizable Armor Slots" Armor, enabled.
Sets LRS's Armor Suit Mod Slots to the same value number as vanilla armor in 2.5.

__________________________________________________________

2.5.1.10 17:15 EST 05JAN2026
...
1. Hotfix to Natural Selection to correct the "too many animals" issue.
...
"Stop Bikes From Falling Over" Standard, enabled.
This is one of those "should be vanilla" mods.

"Witos's FAV" Vehicle, enabled.
Adds a vehicle.

"Bell Go Bong" Audio, enabled.
I chose the variant that just makes a sound when you strike the bell block.
There's an alternate version that summons zombies, but I decided not to do that one.

"Dismember Randomizer" Zombies, disabled.
Zombies can randomly spawn in with missing limbs.

"POI Scourge" QoL, enabled.
A checkmark is placed on the map of each Cleared POI. 
This happens either when you successfully vanquish all zombies on a Clear Quest, or when you kill all of the entities in a POI Boundary outside of a quest.

"Server Enforced Brightness" Graphics, enabled.
Requires Singularity! Disallows other players from changing Brightness on a server.

"TraderSync" Experimental, disabled.
TraderSync let's players use the same NPC trader at the same time and keeps the trader’s item list synced for everyone.
I haven't had the oppurtunity to test this yet. Please let me know if it works in multiplayer without issues.

__________________________________________________________


2.5.1.9 07:00 EST 02JAN2026
...
1. Just a quick hotfix to update CP and CUBP.
...
2.5.1.8 10:40 EST 01JAN2026

Hotfix and micro update:

1. Fixed the Izy animation glove issue.  
I missed the fact that I had accidentally double-nested a folder and the patch failed silently. 
Gloves and animations are now working. 

2. Updated LATT to include Empty Jars in some loot groups.

3. Added Byteblazar's "Natural Selection - Animal AI Overhaul" mod. Zombies, enabled.
Makes animals behave in a more realistic manner.

2.5.1.7 18:15 EST 31DEC2025

You will probably need to start a new save for this update.
...
1. I'm going to wait on LBDR. IZPrebuilt is planning on a new hybrid version, and TFP looks to be going that direction as well.
Let's just wait to see how that develops.

2. Added a new Separator for the CompoPack (CP).  
All of the mods within it are disabled by default.
Warning: CP POIs are more challenging than vanilla!
Also, you get a mixed bag of serious and silly POIs.  
The CP is a historical preservation of every community made POI compiled in one place.
If that is not your jam, just keep these disabled.
A. The Modded-CP contains vanilla POIs built with the Custom Blocks Pack.
B. The Custom Unity Block Pack (CUBP) contains fancier Unity assets in these POIs.
C. There are also NPC-specific POIs, but you must toggle the NPC-Core mod to use these or you will have errors. 

3. This week I got a rash of comments from all over asking for a separate light-weight Mod List version of Smorgasbord. 
They didn't want as many decor, vehicle, OP, NPCs, and silly mods.
I already took some of what they said to heart: Fewer vehicles, no additional Avatars (waifu).
I get this sort of message fairly regularly, but it was non-stop this week.
Here's my general response when I get this request: No.
It's a lot of work maintaining one Wabbajack Mod List already.
I don't want to duplicate my efforts. If I include everything, players can just toggle to their preferences.   
Everyone who comes to the list has different tastes.
I am not interested in Power Fantasy Gaming, but I include Overpowered mods for those people.
I don't play with NPCs, some people love them. 
I don't play with Decor mods, but again for others that's their main thing.  
It would be easier for me if I only included the mods I use in my own game, but this list was made to be modular.
It was also made as a showcase for all of the best (compatible) mods in the community.
I don't tell people how to play, I just provide them options.
The whole point of Smorgasbord being on MO2 is that it allows users to choose what they want like a buffet table.
...
1. I removed the "gloves" portion of Izy's mod to eliminate the third arm animation visual bug.
However, this means you will not see worn gloves when using Izy guns in First Person View. 
There's no way around this issue until Izy makes his next version of the AIO mod.  
I know he's working on it, but no guess as to when it will be ready.
...
Returning mods:
Modded CompoPack POIs
Modded CUBP CompoPack POIs
Most of Hunlight's mods.
A few mods from vinylplz.
Izy toilet pistols.

New stuff:

"Craft Clothing for 2.5" Standard, enabled.
From the Author:
Adds recipes to allow players the ability to craft the (thermal insulating) clothing items brought back into 2.5.
Currently in 2.5, you cannot craft or buy them from traders.
Until TFP fixes that issue in a future update, I made this mod so we can at least craft them. 
I gated the ability to craft these items by locking tier 2 and 3 behind workstations:
Craft Tier 1 Clothing within the Backpack.
Craft Tier 2 Clothing within the Workbench.
Craft Tier 3 Clothing within the Chemistry Station. You must search "Clothing" within the Chemistry Station to find it!

"Black Wolf's AC and Heater inside vehicles (A21 - 1.0 - 2.0)" Vehicles, enabled.
Does what it says.

"Ophidiophobia - True Zombie Survival (No Snakes Wolves Bears Vultures)" Zombies, disabled.
Removes these creatures from global spawning, and replaces some of them with zombies in POIs.

"Audible Breaking Glass Jars" Audio, disabled.
Adds a glass breaking sound when drinking from jars causes the jar to break. 
The game's jar return percentage setting is completely silent - now you'll hear when you lose a jar. 
Configurable sounds, supports custom audio.

__________________________________________________________

2.5.1.6 16:15 EST 29DEC2025
...
1. A community member named donelofficial put in a request on the GitHub Issues tracker for me to add new mods (and missing old ones) to the list.
Most of the additions were by his request.

2. Added the Perks Separator.  I think most of the Perk mods might need some updating.
They should work without errors, but temper your expectations accordingly.
I only did initial testing to confirm no immediate errors at launch into game world.  
I think most of these are OP in general.

3. Added Experimental Separator. 
Test and or use these mods at your own risk.

4. Renamed the EFTX Separator to Weapons and moved some mods around.

5. Massive Overhaul of the GitHub ReadMe! 
A. I added new usable links for the Table of Contents, and embedded within.
B. Added new pages to segment: Troubleshooting, Dedicated Server, Adding Your Own Mods, etc.

Community Requests:

1. If someone out there wants to develop a MO2 Profile around converting Smorgasbord to work with IZPrebuilt's LBDR Mod (plus patches).
2. If any of you have suggestions for improving the GitHub look, feel, or new pages, please let me know.

Mods Removed: 
1. Wild West NPC Cow Hands and add-on patch mod. 
I don't have time to figure out the error it's throwing.

Mods Fixed:
1. Charred Meat Replacer
If you see other warnings or benign errors that might be easy fixes, please let me know.
I sent the fix to the author.

Mods Updated:
1. Danzo Screamers. Fixes.
2. Danzo Hide version number. More options for use.
3. Custom Avatars (VRoid).  Camera, hands, and vehicle issues fixed.
4. Clement Weather is now working as intended

Mods Added:

1. “More Skill Points Per Level” Perks, disabled.
aka 3 Skill Points Per Level

2. “Autominers” OP, disabled. 
Adds new workstations to automine resources.

3. “Efficient Base Repair” Optional, enabled. 
Adds an Efficient Base Repair block.  
Put base repairing resource inside of it and it will repair your base automagically.
You can also toggle it to be able to upgrade your base as well. 
It will do this randomly, so if resources are limited, I recommend you manually upgrade your key blocks.

4. “Hydroponic Farming” Standard, enabled.
Plant indoors in hydroponic tray workstaions. This is not an intuitive system. 
You might need to read up on the NexusMods page to figure out how it works.
One is for seed crafting, the other is for actually growing plants.

5. Perks, disabled.
“Natural Progression” 
“Perk Mastery” (must use CATUI or SteelUI once it's updated for 2.5)
"Legend Perks" (must use CATUI or SteelUI once it's updated for 2.5)
"Legend Perks add-on nerf"

6. “Endless Harvest” OP, disabled.
https://www.nexusmods.com/7daystodie/mods/7554
Harvested plants convert back to sapling plants.

7. "Extended World Settings" Experimental, disabled.
It's "safe" so long as you don't go to extremes in either direction for the settings.  
I don't have the time to test it all. Use good judgement or keep this mod disabled.

8."No Blurry Textures" Experimental, disabled.
This mod is very hardware dependant. 
I don't need it for myself, but some users might benfit by this to prevent blurry texture load-in issues. 
Sometimes this mod might add an occasional random freeze-frame stutter to the game for a second. 
This mod might be better for low end gaming hardware. 

__________________________________________________________


2.5.1.5 16:00 EST 28DEC2025

Added more than 30+ mods we used to have in the older version of Smorgasbord.  
I was able to continue playing in the same 2.5 world I started in an earlier revision, but...
...
2.5.1.3 14:10 EST 27DEC2025

Exclusively for 7DtD game version 2.5!

Comments:

1. Smorgasbord is back!  I took a much needed break and have decided to ressurrect the Mod List.  
I missed playing, modding, and interacting with the community. Plus my kids kept bugging me about it.  
I apologize for leaving the list in a bad state when I left, I accidentally formated my old PC to pass it on to my son...
It took a bit of time to fix, and restore the list from the ground up.
It's not 100% yet, but we'll get there.


2. Going forward I will maintain Smorgasbord, but to protect my own sanity I will be keeping user needs at arms distance.
This is to prevent burnout on my end.
What this means to you:
A. Fewer and slower updates. I'll shoot for monthly.  
B. Less one on one troubleshooting help from FNS. I am working on other projects and am still 66% RTO.  
C. Users are going to have to wait for assistance, use the log bot at Guppy's, rely on help from other community members, figure it out themselves, or suffer.

3. Current Plans:
Add more of the old mods we're missing for 2.5 as they get updated and/or I have time to test them.  
We are missing lots of vehicles, Vehicle Madness, Avatars (VRoid waifus), the CompoPack, and some other heavy hitters.

Gratitude:
StallionsDen for managing my mods during my absence.  I owe him big time!  

For new folks, welcome, for old folks, welcome back!

__________________________________________________________


2.3.2.1 23:30 EST 21SEP2025

For Game version 2.3

Comments:

1. You probably need to start a new save... this is not because that many mods updated, but because I have been disabling several mods.
...
I didn't add any grind, just disabled (but left in place) some mods that were too OP.
...
5. One of our Community Members Rwdillin75 has been experimenting with IZPrebuit's Learn By Doing Returns mod. 
CAUTION! I added this mod to the list, but it is VERY EXPERIMENTAL! 
You need to be a bit of an advanced mod user to attempt this with Smorgasbord.  
You have to disable a few dozen mods for this to work.
Basically, if a mod effects progression, perks, or crafting recipes tied to progression, it needs to be disabled!
I will be posting a follow-up guide in the GutHub ReadMe once I test it out some more.  
...
Armored Zs is now disabled by default with a note explaining this. 
...
From Fin: I disabled this by default because taking away a zombie's ability to climb stairs easily makes some POIs a worse experience. 
...
All of WookieNookie (WMM) mods have been updated.
...
"Rainstorm" 
Laydor added different levels of Fog: You can change this setting in the Gears Mods menu. 
He has Normal vanilla game fog, Rainstorm mode improved fog, and a Silent Hill level of oppressive constant fog. 

__________________________________________________________

2.3.1.4 16:30 EST 14SEP2025
...
1. Moved Halicopter to "Pending Update, broken!" status

2. Disabled a few extraneoues lighting mods I accidentally left enabled during testing.  
...
1. Hot fix, small update on a few mods.
...
However, now in 2.3, it fails more often than not.  
...
"QuickStack"
"Klikai SpeedStar" VRoid waifu.
"WMMSleepUntilDawn"
"EFTX"

__________________________________________________________

2.3.1.2 19:45 EST 13SEP2025
...
"LittleRedSonja Ammunition Recycling"
"Gears"
"7DtD Super Resolution"
"Serenity - Cave Prefabs"

__________________________________________________________

2.3.1.1 21:15 EST 12SEP2025
...
2. I am starting to test adding pregenerated maps for Smorgasbord, you'll see them under the RWG Separator.
...
This map uses the default enabled POIs I already preselected.  So long as you leave the POI Separator mods alone, this map works. 
...
"Fasterer Lockpicking" Replaced by Tam's.
...
"Tam's Improved Lockpicking" OP, enabled.
75% faster lockpicking, 75% more durable lockpicks, spending more perks points in the skill.
...
"Serenity Cave Prefabs by Svarii" POI, enabled.
This pack for The Descent, adds some new cave entrances and underground filler prefabs.

"Klukai SpeedStar" VRoid, Avatar, already manually added.
Another waifu.
